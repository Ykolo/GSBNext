...
CREATE TABLE
  rapport (
    ...
    CONSTRAINT fk_rapport_visiteur FOREIGN KEY (idVisiteur) REFERENCES visiteur (id),
    CONSTRAINT fk_rapport_medecin FOREIGN KEY (idMedecin) REFERENCES medecin (id)
  );
...
CREATE TABLE
  offrir (
    ...
    CONSTRAINT fk_offrir_rapport FOREIGN KEY (idRapport) REFERENCES rapport (id),
    CONSTRAINT fk_offrir_medicament FOREIGN KEY (idMedicament) REFERENCES medicament (id)
  );
...
VALUES
  ...
  ('AAA', 'Antalgiques antipyreques en association'),
  ('AAC', 'Antidepresseur d action centrale'),
  ('AAH', 'Antivertigineux antihistaminique H1'),
  ('ABA', 'Antibiotique antituberculeux'),
  ('ABC', 'Antibiotique antiacnenique local'),
  (
    'ABP',
    'Antibiotique de la famille des beta-lactamines -penicilline A-'
  ),
  ...
  (
    'AIM',
    'Antidepresseur imipraminique -tricyclique-'
  ),
  (
    'AIN',
    'Antidepresseur inhibiteur selectif de la recapture de la setonine'
  ),
  ('ALO', 'Antibiotique local -ORL-'),
  ('ANS', 'Antidepresseur IMAO non selectif'),
  ...
  ('PSA', 'Psychostimulant antiasthesique');
...
VALUES
  ...
  (
    ...
    'FERNANDEZ',
    'Julien',
    '45 rue de du general Scott THIN-LE-MOUTIER 08460',
    '0321760709',
  ...
  (
    ...
    'BOYER',
    'Gilles',
    '33 rue Commandant Heriot MONTIGNY-SUR-MEUSE 08170',
    '0334037052',
    NULL,
    8
  ),
  ...
  (
    ...
    'DURAND',
    'John',
    '92 rue du general de Gaulle SORBIERS 05150',
    '0484328394',
    'HOMEOPATHIE',
    5
  ),
  ...
  (
    ...
    'ROSSI',
    'Nohan',
    '69 rue Mallarme AX-LES-THERMES 09110',
    '0596648531',
    NULL,
    9
  ),
  ...
  (
    ...
    'ROBERT',
    'Anne-Jeanne',
    '26 rue des Armees AVANCON 05230',
    '0442237548',
    NULL,
    5
  ),
  ...
  (
    ...
    'MAURIN',
    'Anne',
    '59 rue de du general Scott MONTCY-NOTRE-DAME 08090',
    '0310431717',
    'ACUPONCTURE',
    8
  ),
  ...
  (
    ...
    'RICHARD',
    'Jerome',
    '39 rue Commandant Heriot BANCIGNY 02140',
    '0315759754',
    NULL,
    2
  ),
  ...
  (
    ...
    'RICARD',
    'Anselme',
    '18 rue de du general Scott BOURG-EN-BRESSE 01000',
    '0428387190',
    'GERONTOLOGIE',
    1
  ),
  ...
  (
    ...
    'LAMBERT',
    'Aude',
    '40 rue Mallarme SAINT-FIRMIN 05800',
    '0434328795',
    NULL,
    5
  ),
  ...
  (
    ...
    'PAUL',
    'Adrien',
    '47 rue Commandant Heriot AUDRESSEIN 09800',
    '0561293920',
    NULL,
    9
  ),
  ...
  (
    ...
    'BOURRELLY',
    'Bernard',
    '46 rue des Nefliers ARROUT 09800',
    '0593876907',
    NULL,
    9
  ),
  ...
  (
    ...
    'OLIVIER',
    'Alizee',
    '23 rue des Nefliers BARZY-SUR-MARNE 02850',
    '0318063658',
    NULL,
    2
  ),
  ...
  (
    ...
    'PAOLI',
    'Martin',
    '77 rue Edouard Heriot PELVOUX 05340',
    '0465821962',
    NULL,
    5
  ),
  ...
  (
    ...
    'VIAL',
    'Fernand',
    '21 rue Commandant Heriot ARROUT 09800',
    '0533982064',
    'ALLERGOLOGIE',
    9
  ),
  ...
  (
    ...
    'TEISSIER',
    'Patrick',
    '35 rue des Cypres MEZIERES-SUR-OISE 02240',
    '0375111486',
    NULL,
    2
  ),
  ...
  (
    ...
    'DIAZ',
    'Aristote',
    '42 rue Edouard Heriot BAGERT 09230',
    '0597457423',
    NULL,
    9
  ),
  ...
  (
    ...
    'ETIENNE',
    'Catherine',
    '81 rue des Cypres SIGOYER 05130',
    '0431018220',
    'Pediatrie',
    5
  ),
  (
    ...
    'GINOUX',
    'Julien',
    '33 rue des Cypres BAGERT 09230',
    '0590592425',
    NULL,
    9
  ),
  ...
  (
    ...
    'GAILLARD',
    'Hamed',
    '88 rue des Armees BELLEY 01300',
    '0425303459',
    NULL,
    1
  ),
  ...
  (
    ...
    'FERRIER',
    'Johnny',
    '62 rue du general de Gaulle BOURG-EN-BRESSE 01000',
    '0479899509',
    'OSTEOPATHIE',
    1
  ),
  ...
  (
    ...
    'DURBEC',
    'Alizee',
    '60 rue Edouard Heriot ASTON 09310',
    '0529196402',
    NULL,
    9
  ),
  ...
  (
    ...
    'JAUBERT',
    'Aristote',
    '5 rue des Cypres AZY-SUR-MARNE 02400',
    '0352734097',
    NULL,
    2
  ),
  ...
  (
    ...
    'LECA',
    'Ingrid',
    '95 rue Mallarme AX-LES-THERMES 09110',
    '0538253531',
    'ALLERGOLOGIE',
    9
  ),
  ...
  (
    ...
    'COLOMBANI',
    'Julienne',
    '95 rue de du general Scott SAINT-FIRMIN 05800',
    '0499781511',
    NULL,
    5
  ),
  ...
  (
    ...
    'DUPUY',
    'Ines',
    '36 rue du general de Gaulle AX-LES-THERMES 09110',
    '0571237673',
    NULL,
    9
  ),
  ...
  (
    ...
    'LUCCHESI',
    'Patrice',
    '25 rue des Nefliers AGUILCOURT 02190',
    '0313705112',
    NULL,
    2
  ),
  ...
  (
    ...
    'ISOARD',
    'Bernard',
    '71 rue Mallarme MESSINCOURT 08110',
    '0366706848',
    NULL,
    8
  ),
  ...
  (
    ...
    'CONSTANT',
    'Gilles',
    '66 rue de du general Scott ARROUT 09800',
    '0590561289',
    'MEDECINE APPLIQUEE AUX SPORTS',
    9
  ),
  ...
  (
    ...
    'MERLIN',
    'Anne-Laure',
    '58 rue du general de Gaulle FALAISE 08400',
    '0381506423',
    NULL,
    8
  ),
  ...
  (
    ...
    'JOLY',
    'Caline',
    '84 rue des Nefliers SAINT-ANDRE-DE-ROSANS 05150',
    '0441770926',
    NULL,
    5
  ),
  (
    ...
    'ROBIN',
    'Amiel',
    '11 rue Commandant Heriot ARROUT 09800',
    '0530054025',
    'GERONTOLOGIE',
    9
  ),
  ...
  (
    ...
    'GIORGI',
    'Gilles',
    '64 rue Commandant Heriot ARANDAS 01230',
    '0466707367',
    NULL,
    1
  ),
  ...
  (
    ...
    'TRON',
    'Charles',
    '81 rue Mallarme BEAUMONT-EN-BEINE 02300',
    '0318112146',
    NULL,
    2
  ),
  ...
  (
    ...
    'GOUIRAND',
    'Hector',
    '73 rue du general de Gaulle AUDRESSEIN 09800',
    '0593896893',
    NULL,
    9
  ),
  ...
  (
    ...
    'ROURE',
    'Anne-Jeanne',
    '20 rue Commandant Heriot BEAUMONT-EN-BEINE 02300',
    '0335062492',
    NULL,
    2
  ),
  ...
  (
    ...
    'ROUSSEAU',
    'Benedicte',
    '2 rue des Armees FALAISE 08400',
    '0392106994',
    NULL,
    8
  ),
  ...
  (
    ...
    'CONTRERAS',
    'Aristote',
    '13 rue des Nefliers ARROUT 09800',
    '0578693214',
    NULL,
    9
  ),
  ...
  (
    ...
    'TARDIEU',
    'sabine',
    '96 rue du general de Gaulle BELLOC 09600',
    '0517690862',
    NULL,
    9
  ),
  ...
  (
    ...
    'LAN',
    'Adelphe',
    '74 rue des Nefliers AUBENTON 02500',
    '0369486130',
    NULL,
    2
  ),
  ...
  (
    ...
    'FONTANA',
    'John',
    '81 rue Edouard Heriot MAYOT 02800',
    '0361434057',
    NULL,
    2
  ),
  ...
  (
    ...
    'FARINA',
    'Victor',
    '86 rue des Armees DOMMARTIN 01380',
    '0447458241',
    NULL,
    1
  ),
  ...
  (
    ...
    'SORRENTINO',
    'Julienne',
    '93 rue des Nefliers MONCEAU-SUR-OISE 02120',
    '0348940958',
    'URGENTISTE',
    2
  ),
  ...
  (
    ...
    'SUZANNE',
    'Prosper',
    '24 rue de du general Scott BRIANCON 05100',
    '0493163850',
    NULL,
    5
  ),
  ...
  (
    ...
    'SARDOU',
    'Venus',
    '84 rue des Armees MONTIGNY-SUR-MEUSE 08170',
    '0332562475',
    NULL,
    8
  ),
  ...
  (
    ...
    'PIGNATEL',
    'Catherine',
    '4 rue des Armees AUBENTON 02500',
    '0368054817',
    NULL,
    2
  ),
  (
    ...
    'CECCALDI',
    'Bernard',
    '64 rue Commandant Heriot TRAVECY 02800',
    '0315061114',
    NULL,
    2
  ),
  ...
  (
    ...
    'RICHIER',
    'Fernand',
    '37 rue du general de Gaulle AUGIREIN 09800',
    '0517286774',
    NULL,
    9
  ),
  ...
  (
    ...
    'ARTAUD',
    'Austine',
    '37 rue des Armees SIGOYER 05130',
    '0485539010',
    NULL,
    5
  ),
  ...
  (
    ...
    'FUENTES',
    'Patrick',
    '97 rue du general de Gaulle AUBENTON 02500',
    '0378805449',
    NULL,
    2
  ),
  ...
  (
    ...
    'ROSA',
    'Benedicte',
    '37 rue Mallarme SAINT-CREPIN 05600',
    '0472480246',
    NULL,
    5
  ),
  ...
  (
    ...
    'MARCHI',
    'Fatima',
    '32 rue des Armees MEZIERES-SUR-OISE 02240',
    '0335733742',
    NULL,
    2
  ),
  ...
  (
    ...
    'ALVAREZ',
    'Alice',
    '94 rue des Cypres SAINT-FIRMIN 05800',
    '0492845898',
    NULL,
    5
  ),
  ...
  (
    ...
    'IVALDI',
    'Alain',
    '61 rue de du general Scott QUATRE-CHAMPS 08400',
    '0395171820',
    NULL,
    8
  ),
  ...
  (
    ...
    'RENAUD',
    'Aude',
    '73 rue Mallarme SORBIERS 05150',
    '0415973212',
    'Pediatrie',
    5
  ),
  ...
  (
    ...
    'FRANCO',
    'Jules',
    '50 rue des Cypres BARENTON-SUR-SERRE 02270',
    '0377237270',
    NULL,
    2
  ),
  ...
  (
    ...
    'MATTIO',
    'Armelle',
    '24 rue des Nefliers QUATRE-CHAMPS 08400',
    '0371872007',
    'OSTEOPATHIE',
    8
  ),
  ...
  (
    ...
    'TOMASI',
    'Cristophe',
    '86 rue Mallarme ORCIERES 05170',
    '0488800978',
    NULL,
    5
  ),
  ...
  (
    ...
    'TOMASINI',
    'Austine',
    '44 rue des Nefliers CHEZY-SUR-MARNE 02570',
    '0363569859',
    NULL,
    2
  ),
  ...
  (
    ...
    'AVON',
    'Aurèle',
    '10 rue du general de Gaulle ARROUT 09800',
    '0554301843',
    NULL,
    9
  ),
  ...
  (
    ...
    'COQUILLAT',
    'Fatima',
    '16 rue Commandant Heriot BANCIGNY 02140',
    '0334753913',
    NULL,
    2
  ),
  (
    ...
    'SARKISSIAN',
    'Adrien',
    '2 rue Commandant Heriot MONCEAU-SUR-OISE 02120',
    '0352372278',
    'MEDECINE APPLIQUEE AUX SPORTS',
    2
  ),
...
VALUES
  ...
  (
    ...
    'COMBES',
    'Fatima',
    '88 rue du general de Gaulle DOMMARTIN 01380',
    '0436582548',
    'URGENTISTE',
    1
  ),
  (
    ...
    'BOTTERO',
    'Marie',
    '65 rue Edouard Heriot ABBECOURT 02300',
    '0316457802',
    'HOMEOPATHIE',
    2
  ),
  ...
  (
    ...
    'RIMBAUD',
    'Patricia',
    '75 rue du general de Gaulle FALAISE 08400',
    '0359521971',
    NULL,
    8
  ),
  ...
  (
    ...
    'PESCE',
    'Firmin',
    '66 rue Commandant Heriot AX-LES-THERMES 09110',
    '0560293085',
    NULL,
    9
  ),
  ...
  (
    ...
    'OLIVERO',
    'Aline',
    '63 rue du general de Gaulle MONTCY-NOTRE-DAME 08090',
    '0330296222',
    NULL,
    8
  ),
  (
    ...
    'BONELLI',
    'Anne-Sophie',
    '28 rue du general de Gaulle BRIANCON 05100',
    '0466993498',
    'GERONTOLOGIE',
    5
  ),
  (
    ...
    'DOMERGUE',
    'Bernard',
    '47 rue du general de Gaulle CAMON 09500',
    '0534440216',
    NULL,
    9
  ),
  ...
  (
    ...
    'OLLIER',
    'Rosalie',
    '15 rue Edouard Heriot ARROUT 09800',
    '0553692792',
    NULL,
    9
  ),
  ...
  (
    ...
    'GUIEN',
    'Reissa',
    '65 rue du general de Gaulle AZY-SUR-MARNE 02400',
    '0374955418',
    NULL,
    2
  ),
  ...
  (
    ...
    'CAPARROS',
    'Patrick',
    '28 rue des Cypres OYONNAX 01100',
    '0456081235',
    NULL,
    1
  ),
  ...
  (
    ...
    'MACCARIO',
    'Julie',
    '30 rue de du general Scott SAINT-FIRMIN 05800',
    '0440937400',
    NULL,
    5
  ),
  ...
  (
    ...
    'CAMPO',
    'Martial',
    '41 rue du general de Gaulle AUGIREIN 09800',
    '0569674646',
    NULL,
    9
  ),
  ...
  (
    ...
    'BARRIOL',
    'Cristophe',
    '88 rue du general de Gaulle BOULIGNEUX 01330',
    '0435544779',
    NULL,
    1
  ),
  ...
  (
    ...
    'GUERRINI',
    'Cristophe',
    '18 rue Edouard Heriot CHALLES 01450',
    '0428126087',
    NULL,
    1
  ),
  ...
  (
    ...
    'ROYERE',
    'Serge',
    '61 rue Mallarme SAVINES-LE-LAC 05160',
    '0489512105',
    NULL,
    5
  ),
  ...
  (
    ...
    'BELTRAN',
    'Aude',
    '98 rue des Cypres SAINT-CREPIN 05600',
    '0458369404',
    NULL,
    5
  ),
  ...
  (
    ...
    'EYRAUD',
    'Julie',
    '29 rue de du general Scott SAINT-ANDRE-DE-ROSANS 05150',
    '0450980762',
    NULL,
    5
  ),
  (
    ...
    'BARRE',
    'Roby',
    '14 rue Mallarme LAVAL-MORENCY 08150',
    '0350310027',
    'ANGEIOLOGIE',
    8
  ),
  ...
  (
    ...
    'PIANA',
    'Carole',
    '49 rue de du general Scott HOUDILCOURT 08190',
    '0318196859',
    NULL,
    8
  ),
  (
    ...
    'VILLEVIEILLE',
    'Armelle',
    '70 rue Mallarme LAVAL-MORENCY 08150',
    '0330805895',
    NULL,
    8
  ),
  ...
  (
    ...
    'ALBANO',
    'Rosalie',
    '9 rue Mallarme SAINT-CREPIN 05600',
    '0470298666',
    NULL,
    5
  ),
  (
    ...
    'BARALE',
    'Jordan',
    '36 rue Mallarme MONCEAU-SUR-OISE 02120',
    '0337902134',
    NULL,
    2
  ),
  ...
  (
    ...
    'GALLIANO',
    'Fernand',
    '42 rue Edouard Heriot ARROUT 09800',
    '0515601750',
    NULL,
    9
  ),
  ...
  (
    ...
    'BONHOMME',
    'Hypolite',
    '45 rue des Nefliers ORCIERES 05170',
    '0435503130',
    NULL,
    5
  ),
  ...
  (
    ...
    'COSSU',
    'Caline',
    '46 rue Mallarme MONTCEAUX 01090',
    '0420799374',
    'MEDECINE APPLIQUEE AUX SPORTS',
    1
  ),
  ...
  (
    ...
    'GARIBALDI',
    'Johnny',
    '80 rue de du general Scott JOIGNY-SUR-MEUSE 08700',
    '0386814494',
    NULL,
    8
  ),
  ...
  (
    ...
    'MIRALLES',
    'Aristote',
    '74 rue des Nefliers SAINT-LAURENT-SUR-SAONE 01750',
    '0417675151',
    NULL,
    1
  ),
  ...
  (
    ...
    'FIORE',
    'Jeremie',
    '19 rue Commandant Heriot CEYZERIAT 01250',
    '0426848534',
    'URGENTISTE',
    1
  ),
  ...
  (
    ...
    'CROCE',
    'Anemone',
    '21 rue Commandant Heriot BELLEY 01300',
    '0465513099',
    NULL,
    1
  ),
  ...
  (
    ...
    'POURCEL',
    'Andre',
    '95 rue Edouard Heriot SAINT-FIRMIN 05800',
    '0483174531',
    'HOMEOPATHIE',
    5
  ),
  ...
  (
    ...
    'GRECH',
    'Ines',
    '71 rue Edouard Heriot ASTON 09310',
    '0543065471',
    'HOMEOPATHIE',
    9
  ),
  ...
  (
    ...
    'DELERIA',
    'Patrice',
    '30 rue de du general Scott SAINT-SAUVEUR 05200',
    '0412740574',
    NULL,
    5
  ),
  (
    ...
    'JAYNE',
    'Alizee',
    '24 rue Commandant Heriot HERBEUVAL 08370',
    '0372811016',
    NULL,
    8
  ),
  ...
  (
    ...
    'SALA',
    'Amelie',
    '90 rue des Nefliers HOUDILCOURT 08190',
    '0360017048',
    NULL,
    8
  ),
  ...
  (
    ...
    'MANOUKIAN',
    'Aline',
    '66 rue des Cypres ROCHEBRUNE 05190',
    '0474044568',
    'HOMEOPATHIE',
    5
  ),
  ...
  (
    ...
    'GIUSIANO',
    'Andrew',
    '63 rue de du general Scott SAINTE-MARIE 05150',
    '0496424640',
    NULL,
    5
  ),
  (
    ...
    'CANAVESE',
    'Fatima',
    '9 rue des Cypres FRESSANCOURT 02800',
    '0399807861',
    NULL,
    2
  ),
  ...
  (
    ...
    'PASTORE',
    'Annie',
    '96 rue du general de Gaulle AX-LES-THERMES 09110',
    '0599243446',
    NULL,
    9
  ),
  ...
  (
    ...
    'MEYNIER',
    'Hypolite',
    '70 rue des Nefliers CHALLES 01450',
    '0476171240',
    NULL,
    1
  ),
  (
    ...
    'CORDIER',
    'Sophie',
    '43 rue des Armees BRIANCON 05100',
    '0415807023',
    NULL,
    5
  ),
  ...
  (
    ...
    'TIRAN',
    'Ines',
    '43 rue du general de Gaulle AUGIREIN 09800',
    '0598718886',
    NULL,
    9
  ),
  ...
  (
    ...
    'ARQUIER',
    'Julie',
    '40 rue des Armees AMBRIEF 02200',
    '0361450183',
    NULL,
    2
  ),
  ...
  (
    ...
    'SEGOND',
    'Martial',
    '86 rue du general de Gaulle BARZY-SUR-MARNE 02850',
    '0317141855',
    NULL,
    2
  ),
  (
    ...
    'BOURGEOIS',
    'Roby',
    '9 rue du general de Gaulle SAINT-ANDRE-DE-ROSANS 05150',
    '0487582509',
    NULL,
    5
  ),
  (
    ...
    'ALEXIS',
    'Aurèle',
    '87 rue des Armees BARZY-SUR-MARNE 02850',
    '0338003620',
    NULL,
    2
  ),
  ...
  (
    ...
    'DIJON',
    'Bertrand',
    '46 rue des Nefliers AUBENTON 02500',
    '0347004937',
    NULL,
    2
  ),
  ...
  (
    ...
    'DA SILVA',
    'Yoan',
    '16 rue des Cypres ROCHEBRUNE 05190',
    '0447561911',
    NULL,
    5
  ),
  ...
  (
    ...
    'MAESTRACCI',
    'Julien',
    '16 rue Mallarme JUNIVILLE 08310',
    '0387772024',
    NULL,
    8
  ),
  (
    ...
    'BOURGES',
    'Beatrice',
    '56 rue de du general Scott BLYES 01150',
    '0497830362',
    NULL,
    1
  ),
  ...
  (
    ...
    'LACOMBE',
    'Venus',
    '42 rue Mallarme SAINT-FIRMIN 05800',
    '0496188645',
    NULL,
    5
  ),
  ...
  (
    ...
    'GIORDANENGO',
    'Beatrice',
    '83 rue Mallarme LAVAL-MORENCY 08150',
    '0353669720',
    NULL,
    8
  ),
  ...
  (
    ...
    'DELESTRADE',
    'Adrien',
    '67 rue Mallarme NEUVILLE-LES-DAMES 01400',
    '0483807492',
    NULL,
    1
  ),
  ...
  (
    ...
    'DONNAT',
    'Benedicte',
    '52 rue Mallarme SAINT-FIRMIN 05800',
    '0498785723',
    NULL,
    5
  ),
  ...
  (
    ...
    'MAGGIO',
    'Austine',
    '65 rue Mallarme MONTCEAUX 01090',
    '0470285907',
    NULL,
    1
  ),
  ...
  (
    ...
    'GRENIER',
    'François',
    '33 rue des Armees JOIGNY-SUR-MEUSE 08700',
    '0349739798',
    NULL,
    8
  ),
  ...
  (
    ...
    'SALLES',
    'Anne-Lucie',
    '10 rue des Armees JUNIVILLE 08310',
    '0323215933',
    'Pediatrie',
    8
  ),
  ...
  (
    ...
    'POURRIERE',
    'Anne-Lucie',
    '30 rue des Nefliers FRESSANCOURT 02800',
    '0375894393',
    NULL,
    2
  ),
...
VALUES
  (
    ...
    'TRIMYCINE',
    'CRT',
    'Triamcinolone acetonide + Neomycine + Nystatine',
    'Ce medicament est un corticoïde à  activite forte ou très forte associe à  un antibiotique et un ant',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants  d infections de la peau'
  ),
  (
    'ADIMOL9',
    'ADIMOL',
    ...
    'Ce medicament  plus puissant que les penicillines simples  est utilise pour traiter des infections b',
    'Ce medicament est contre-indique en cas d allergie aux penicillines ou aux cephalosporines.'
  ),
  (
    'AMOPIL7',
    'AMOPIL',
    ...
    'Amoxicilline',
    'Ce medicament  plus puissant que les penicillines simples  est utilise pour traiter des infections b',
    'Ce medicament est contre-indique en cas d allergie aux penicillines. Il doit être administre avec pr'
  ),
  (
    'AMOX45',
    'AMOXAR',
    ...
    'Amoxicilline',
    'Ce medicament  plus puissant que les penicillines simples  est utilise pour traiter des infections b',
    'La prise de ce medicament peut rendre positifs les tests de depistage du dopage.'
  ),
  (
    'AMOXIG12',
    'AMOXI Ge',
  ...
  (
    ...
    'APATOUX Vitamine C',
    'ALO',
    'Tyrothricine + Tetracaïne + Acide ascorbique (Vitamine C)',
    'Ce medicament est utilise pour traiter les affections de la bouche et de la gorge.',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants  en cas de phenylcetonur'
  ),
  (
    'BACTIG10',
    'BACTIGEL',
    'ABC',
    'Erythromycine',
    'Ce medicament est utilise en application locale pour traiter l acne et les infections cutanees bacte',
    'Ce medicament est contre-indique en cas d allergie aux antibiotiques de la famille des macrolides ou'
  ),
  (
    'BACTIV13',
    'BACTIVIL',
    'AFM',
    'Erythromycine',
    'Ce medicament est utilise pour traiter des infections bacteriennes specifiques.',
    'Ce medicament est contre-indique en cas d allergie aux macrolides (dont le chef de file est l erythr'
  ),
  (
    'BITALV',
    'BIVALIC',
    'AAA',
    'Dextropropoxyphène + Paracetamol',
    'Ce medicament est utilise pour traiter les douleurs d intensite moderee ou intense.',
    'Ce medicament est contre-indique en cas d allergie aux medicaments de cette famille  d insuffisance '
  ),
  (
    'CARTION6',
    'CARTION',
    'AAA',
    'Acide acetylsalicylique (aspirine) + Acide ascorbique (Vitamine C) + Paracetamol',
    'Ce medicament est utilise dans le traitement symptomatique de la douleur ou de la fièvre.',
    'Ce medicament est contre-indique en cas de troubles de la coagulation (tendances aux hemorragies)  d'
  ),
  (
    'CLAZER6',
    'CLAZER',
    'AFM',
    'Clarithromycine',
    'Ce medicament est utilise pour traiter des infections bacteriennes specifiques. Il est egalement uti',
    'Ce medicament est contre-indique en cas d allergie aux macrolides (dont le chef de file est l erythr'
  ),
  (
    'DEPRIL9',
    ...
    'AIM',
    'Clomipramine',
    'Ce medicament est utilise pour traiter les episodes depressifs sevères  certaines douleurs rebelles ',
    'Ce medicament est contre-indique en cas de glaucome ou d adenome de la prostate  d infarctus recent '
  ),
  (
    'DIMIRTAM6',
    'DIMIRTAM',
    'AAC',
    'Mirtazapine',
    'Ce medicament est utilise pour traiter les episodes depressifs sevères.',
    'La prise de ce produit est contre-indiquee en cas de d allergie à  l un des constituants.'
  ),
  (
    'DOLRIL7',
    'DOLORIL',
    ...
    'Acide acetylsalicylique (aspirine) + Acide ascorbique (Vitamine C) + Paracetamol',
    'Ce medicament est utilise dans le traitement symptomatique de la douleur ou de la fièvre.',
    'Ce medicament est contre-indique en cas d allergie au paracetamol ou aux salicylates.'
  ),
  (
    'DORNOM8',
    'NORMADOR',
    'HYP',
    'Doxylamine',
    'Ce medicament est utilise pour traiter l insomnie chez l adulte.',
    'Ce medicament est contre-indique en cas de glaucome  de certains troubles urinaires (retention urina'
  ),
  (
    'EQUILARX6',
    'EQUILAR',
    'AAH',
    'Meclozine',
    'Ce medicament est utilise pour traiter les vertiges et pour prevenir le mal des transports.',
    'Ce medicament ne doit pas être utilise en cas d allergie au produit  en cas de glaucome ou de retent'
  ),
  (
    'EVILR7',
    'EVEILLOR',
    'PSA',
    'Adrafinil',
    'Ce medicament est utilise pour traiter les troubles de la vigilance et certains symptomes neurologiq',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants.'
  ),
  (
    'INSXT5',
    'INSECTIL',
    'AH',
    'Diphenydramine',
    'Ce medicament est utilise en application locale sur les piqûres d insecte et l urticaire.',
    'Ce medicament est contre-indique en cas d allergie aux antihistaminiques.'
  ),
  (
    'JOVAI8',
    'JOVENIL',
  ...
  (
    ...
    'LIDOXYTRACINE',
    'AFC',
    'Oxytetracycline +Lidocaïne',
    'Ce medicament est utilise en injection intramusculaire pour traiter certaines infections specifiques',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants. Il ne doit pas être ass'
  ),
  (
    'LITHOR12',
    'LITHORINE',
    'AP',
    'Lithium',
    'Ce medicament est indique dans la prevention des psychoses maniaco-depressives ou pour traiter les e',
    'Ce medicament ne doit pas être utilise si vous êtes allergique au lithium. Avant de prendre ce trait'
  ),
  (
    'PARMOL16',
    'PARMOCODEINE',
    'AA',
    'Codeine + Paracetamol',
    'Ce medicament est utilise pour le traitement des douleurs lorsque des antalgiques simples ne sont pa',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants  chez l enfant de moins '
  ),
  (
    'PHYSOI8',
    'PHYSICOR',
    'PSA',
    'Sulbutiamine',
    'Ce medicament est utilise pour traiter les baisses d activite physique ou psychique  souvent dans un',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants.'
  ),
  (
    'PIRIZ8',
    ...
    'ABA',
    'Pyrazinamide',
    'Ce medicament est utilise  en association à  d autres antibiotiques  pour traiter la tuberculose.',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants  d insuffisance renale o'
  ),
  (
    'POMDI20',
    'POMADINE',
    'AO',
    'Bacitracine',
    'Ce medicament est utilise pour traiter les infections oculaires de la surface de l oeil.',
    'Ce medicament est contre-indique en cas d allergie aux antibiotiques appliques localement.'
  ),
  (
    'TROXT21',
    'TROXADET',
    'AIN',
    'Paroxetine',
    'Ce medicament est utilise pour traiter la depression et les troubles obsessionnels compulsifs. Il pe',
    'Ce medicament est contre-indique en cas d allergie au produit.'
  ),
  (
    'TXISOL22',
    'TOUXISOL',
    ...
    'Ce medicament est utilise pour traiter les affections de la bouche et de la gorge.',
    'Ce medicament est contre-indique en cas d allergie à  l un des constituants et chez l enfant de moin'
  ),
  (
    'URIEG6',
    'URIREGUL',
    ...
    'Ce medicament est utilise pour traiter les infections urinaires simples chez la femme de moins de 65',
    'La prise de ce medicament est contre-indiquee en cas d allergie à l un des constituants et d insuffi'
  );
...
INSERT INTO
  rapport (id, date, motif, bilan, idVisiteur, idMedecin)
VALUES
  (
    1,
    '2017-01-02',
  ...
  (
    ...
    '2016-07-02',
    'Demande du medecin',
    'Très aimable maintenir un contact regulier',
    'a93',
    4
  ),
  (
  ...
  (
    ...
    '2016-07-02',
    'Prise de contact',
    'Très fixe sur les produits utilises',
    'd13',
    639
  ),
  (
  ...
  (
    ...
    '2016-07-03',
    'Prise de contact',
    'Très interesse par les produits presentes',
    'a131',
    935
  ),
  (
  ...
  (
    ...
    '2016-07-03',
    'recommandation de confrère',
    'A beaucoup appecie notre rencontre',
    'c14',
    381
  ),
  (
  ...
  (
    ...
    '2016-07-03',
    'Installation nouvelle',
    'Jeune medecin decouvrant les visiteurs',
    'b19',
    352
  ),
  (
  ...
  (
    596,
    '2016-11-05',
    'Nouveau medecin, prise de contact',
    'Très positif, très interesse, à revoir au plus vite',
    'a131',
    614
  ),
  (
    ...
    '2016-11-05',
    'Visite annuelle',
    'Très presse, peu ouvert mais très courtois, ecoute avec interêt. En attente de resultats',
    'a131',
    87
  ),
  (
    ...
    '2017-02-05',
    'Demande du medecin',
    'Interessee, je dois la revoir le mois prochain ou dans deux mois, prevoir un rendez-vous',
    'a131',
    577
  ),
  (
